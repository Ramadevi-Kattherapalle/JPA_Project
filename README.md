...
A Java EE web application that performs full CRUD (Create, Read, Update, Delete) operations for managing employee records using Java Persistence API (JPA).  
This project follows a clean layered architecture with Controller, Service, DAO, and Entity layers.  
...
- **Entity Layer** – Maps Java class to database table
- 
## 3. Project Structure
JPAproject/
│
